					...
					<form action="ServerUploadeAtualiza" method="post">
						...
						<div class="form-row">
							<div class="form-group col-md-10">
								...
								<p><%=rs1.getInt("id_upload")%><%=rs1.getString("descricao_doc")%><%=rs1.getInt("id_doc")%></p>
							</div>
						...
						<div class="form-row">
							<div class="col-md-12 text-center">
								...
								<a type="submit" class="btn btn-outline-primary" href="sucesso.jsp?id_candidato=<%= rs.getInt("id_candidato")%>">
